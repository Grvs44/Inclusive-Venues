...
class ReviewTestCase(TestCase):
    ...
    @tag('sprint3', 'review_detail')
    def test_review_detail_other(self):
        '''Test a user cannot view another user's review (as if it was theirs)'''
